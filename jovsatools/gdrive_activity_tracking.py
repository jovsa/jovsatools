...
__all__ = ['truncated', 'getOneOf', 'getTimeInfo', 'getActionInfo', 'getUserInfo', 'getActorInfo', 'getTargetInfo',
           'initialize_data', 'get_authors', 'convert_dates', 'get_drive_activity', 'SCOPES', 'clean_data', 'get_data']
...
def clean_data(data):
    ...
    # actor
    data['num_actors'] = data.apply(lambda x: len(x['actor']), axis=1)

    return data


def get_data(page_size, loc):
